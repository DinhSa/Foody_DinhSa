...
public class Adapter_Tab3_Angi extends BaseExpandableListAdapter {
    private Context _context;
    private ArrayList<String> _listDataHeader; // header titles
    // child data in format of header title, child title
    private HashMap<String, ArrayList<String>> _listDataChild;

    public Adapter_Tab3_Angi(Context context, ArrayList<String> listDataHeader,
    ...
    public View getGroupView(final int groupPosition, final boolean b, View view, final ViewGroup viewGroup) {
        ...
        tvHeader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TextView txt=(TextView) fragment_angi.mTabHost.getTabWidget().getChildAt(3).findViewById(R.id.tabsText);
                TabActivity_3_angi.KieuDiaDiem="QuanHuyen";
                TabActivity_3_angi.TenDiaDiem=ten;
                txt.setText(ten);
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean b, View view, ViewGroup viewGroup) {
        ...
        tvItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TextView txt=(TextView) fragment_angi.mTabHost.getTabWidget().getChildAt(3).findViewById(R.id.tabsText);
                TabActivity_3_angi.KieuDiaDiem="DuongPho";
                TabActivity_3_angi.TenDiaDiem=data;
                txt.setText(data);
                txt.setTextColor(Color.RED);
                fragment_angi.mTabHost.setCurrentTab(0);
                MainActivity.mBottomBar.setVisibility(View.VISIBLE);
