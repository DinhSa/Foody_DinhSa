...
//
//    public ExpandableListViewAdapter(Context context, ArrayList<String> listDataHeader,
...
//                Doi_ThanhPho.KieuDiaDiem="QuanHuyen";
//                Doi_ThanhPho.TenDiaDiem=ten;
//                txt.setText(ten);
//                txt1.setText(ten);
...
//                TextView txt=(TextView) fragment_odau.mTabHost.getTabWidget().getChildAt(3).findViewById(R.id.tabsText);
//                TextView txt1=(TextView) fragment_angi.mTabHost.getTabWidget().getChildAt(3).findViewById(R.id.tabsText);
//                Doi_ThanhPho.KieuDiaDiem="DuongPho";
//                Doi_ThanhPho.TenDiaDiem=data;
//                txt.setText(data);
//                txt1.setText(data);
//                txt.setTextColor(Color.RED);
//                txt1.setTextColor(Color.RED);
