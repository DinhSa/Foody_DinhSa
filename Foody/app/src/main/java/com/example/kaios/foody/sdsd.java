...
// */
//
//public class DoiHinhDaiDien extends Activity {
...
//        setContentView(R.layout.activity_doi_hinh_daidien);
//
...
//                    getChangeImage(user.getTaiKhoan(), image);
//                }
//            }
//        });
//    }
...
//            e.printStackTrace();
//        }
//        FoodyRestClient doihinh = new FoodyRestClient();
...
//                        user.setHinhDaiDien(BitmapFactory.decodeByteArray(byteArray, 0, byteArray.length));
//                        //Về trang chủ
//                        Intent intent = new Intent(DoiHinhDaiDien.this, MainActivity.class);
